...
int main()
{
    int informacion[3][4] = {{1,120,150,220},{2,160,230},{3,100,120,200}};
    ...
    float promedio_temp_medio = suma_temp_media/3;
    float promedio_temp_alta = suma_temp_alta/3;

    printf("Promedio temporada baja: %.2f\nPromedio temporada media: %2f\nPromedio temporada alta: %2f",promedio_temp_baja,promedio_temp_medio,promedio_temp_alta);
}
